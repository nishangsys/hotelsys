...
$(".addmore").on('click',function(){
	...
	html += '<td><input type="text" name="total[]" id="total_'+i+'" readonly class="form-control totalLinePrice" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"></td>';
		html += '<td><input type="text" name="alltotal[]" id="alltotal_'+i+'" readonly class="form-control alltotalLinePrice" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" style="background:#f00; color:#fff" onpaste="return false;"></td>';
