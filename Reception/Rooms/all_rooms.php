			...
			?>
												...
												<div class="widget-box">
													...
													<div class="widget-body">
														<div class="widget-main">
															...
															$aa = $con->query("SELECT * from colors,rooms,categories
											...
											<ul class="dropdown-menu dropdown-inverse">
												...
												<li>
													<a href="#" style="color:#033; font-weight:bold">From <?php echo number_format($rows['min_cost']); ?> </a>
												</li>

												<li>
													<a href="?<?php echo $row['link']; ?>" style="color:#039; font-weight:bold"><?php echo $row['link_name']; ?></a>
												</li>
