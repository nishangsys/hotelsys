			...
			?>
                                                               ...
                                                               <input type="hidden" name="cust_id" value="<?php echo $cust_id=$rows['cust_id']; ?>"   />
                                                                 ...
                                                                 <div class="form-row">
                                                                    ...
                                                                    <div class="form-group col-md-2">
                                                                      ...
                                                                      <input type="text" name="paid" autocomplete="off"  onBlur="doCalc(this.form)"  
									...
									<div class="col-sm-3">
										<div class="widget-box widget-color-blue2">
											<div class="widget-header">
											<?php echo $rows['cust_name']; ?>  Room <?php echo $rows['room_num']; ?>  Payments today 
											...
											<div class="widget-body">
												...
												$date=date('Y-m-d');
												$a = $con->query("SELECT * from room_occupancy,daily where daily.cust_id='".$cust_id."' AND                                                 daily.room_id='".$room_id."' and daily.amt_paid>0 and daily.date='$date' and room_occupancy.cust_id=daily.cust_id
												...
												?>
													<tr>
														...
														?>   </td>
                                                        <td><a href="?new_payments&res=<?php echo $_GET['res']; ?>&cust_id=<?php echo $_GET['cust_id']; ?>&rid=<?php echo $_GET['rid']; ?>&link=<?php echo $_GET['link']; ?>&delete=<?php echo $rowm['id']; ?>&gdgdg" onclick="return confirm('Are you Sure you wish to Delete')">Delete</a>
