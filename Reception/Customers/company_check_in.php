			...
			?>
											...
											<ul class="dropdown-menu dropdown-inverse">
												...
												<li>
													<a href="?company_checkin&cust=<?php echo $_GET['cust_id']; ?>&rid=<?php echo $row['id']; ?>&comp_id=<?php echo $_GET['comp_id']; ?>&fsfsf" style="color:#039; font-weight:bold"><?php echo $row['link_name']; ?></a>
												</li>
