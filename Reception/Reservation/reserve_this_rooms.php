			 ...
			 <?php
				ReserveRoom();
			$a = $con->query("SELECT * from rooms,categories,customers where rooms.cate_id=categories.id 
			AND rooms.id='".$_GET['rid']."' AND customers.id='".$_GET['cust_id']."'") or die(mysqli_error($con));
                                                                  ...
                                                                  <div class="form-row">
                                                                    ...
                                                                    <div class="form-group col-md-3">
                                                                     ...
                                                                     <div class="form-group col-md-3">
                                                                      ...
                                                                      <input type="date"    name="date" class="form-control"  required placeholder="Customers' Tel Num">
